...
export default function FeaturesGrid() {
    return (
        <section className="relative py-24 bg-gradient-to-bl from-primary/90 to-black overflow-hidden">
            ...
            <div className="relative container mx-auto px-4">
                <div className="text-center mb-16 space-y-6">
                    ...
                    <p className="text-md md:text-lg text-white/80 max-w-screen-lg w-full mx-auto leading-relaxed border border-white/20 p-2 rounded-lg backdrop-blur-sm">
